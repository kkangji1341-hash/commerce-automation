...
from app.services.keyword_analysis_engine import KeywordAnalysis, CompetitionLevel
...
class RecommendedProduct:
    ...
    def roi_percent(self) -> float:
        """투자 수익률"""
        initial_investment = self.cost_of_goods * self.source_product.min_order_quantity
        if initial_investment == 0:
            return 0
        return (self.estimated_monthly_profit / initial_investment) * 100
...
def test_product_recommendation():
    ...
    from keyword_analysis_engine import KeywordAnalysisEngine, KeywordData
